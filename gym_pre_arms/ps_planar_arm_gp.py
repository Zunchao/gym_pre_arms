...
class SimEnv3Joints():
    ...
    def run(self):
        ...
        self.csvwr.writecsv(filepath=currentdir+'/goal_gp.csv', data=allgoals)
        ...
        self.csvwr.writecsv(currentdir+'/inputX_gp.csv', X)
        self.csvwr.writecsv(currentdir+'/outputY_gp.csv', Y)
