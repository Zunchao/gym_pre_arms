...
class SimEnv3Joints():
    ...
    def reset(self):
        ...
        theta2 = np.random.random(1)*pi
        theta3 = np.random.random(1)*pi
    ...
    def run(self):
        ...
        self.csvwr.writecsv(filepath=currentdir+'/goal_ori_rand.csv', data=allgoals)
        ...
        for t in range(numTrials):
            ...
            '''
        self.csvwr.writecsv(currentdir+'/inputX_ori_rand.csv', X)
        self.csvwr.writecsv(currentdir+'/outputY_ori_rand.csv', Y)
        '''
